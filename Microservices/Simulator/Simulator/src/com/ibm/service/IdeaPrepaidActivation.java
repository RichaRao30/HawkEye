...
public class IdeaPrepaidActivation {
	...
	public void randomIdeaAct() {
		...
		insertIA(caf,retailer,customer,doc,hname,circle,sim);
	}
	
	public void insertIA(String caf,String retailer,int customer,String doc,String hname,int circle,String sim) {
		String time;
		try {
			...
			//String sql="insert into IDEA_PREPAID_ACTIVATION values('"+caf+"','2020-06-13 08:10:38','"+retailer+"',"+customer+",'"+doc+"','"+hname+"',"+circle+",'"+sim+"')";
			String sql="insert into IDEA_PREPAID_ACTIVATION values('"+caf+"','"+time+"','"+retailer+"',"+customer+",'"+doc+"','"+hname+"',"+circle+",'"+sim+"')";
