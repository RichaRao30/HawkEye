...
public class IdeaTopup{
	...
	public void randomITopup() {
		...
		insertITop(id,retailer,customer,amt,circle,msg);
	}
	
	public void insertITop(String id,String retailer,String customer,int amt,int circle,String msg){
		String time;
		try {
			...
			//String sql="insert into IDEA_TOPUP_TRANSACTIONS values('"+id+"','2020-06-04 15:23:38','"+retailer+"','"+customer+"',"+amt+","+circle+",'"+msg+"')";
			String sql="insert into IDEA_TOPUP_TRANSACTIONS values('"+id+"','"+time+"','"+retailer+"','"+customer+"',"+amt+","+circle+",'"+msg+"')";
