...
public class ChartRecharge2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_chart_recharge2, container, false);
        pieChart=(PieChart) view.findViewById(R.id.chart_recharge);

        data();

        swipeRefreshLayout=view.findViewById(R.id.refresh_chartrech2);
    ...
    public void data(){
        ...
        Call<List<ReportVO>> call=apiInterface.getChartRecharge();
        call.enqueue(new Callback<List<ReportVO>>() {
            ...
            public void onResponse(Call<List<ReportVO>> call, Response<List<ReportVO>> response) {
                ...
                PieDataSet dataSet=new PieDataSet(yValues,"Recharge Data");
