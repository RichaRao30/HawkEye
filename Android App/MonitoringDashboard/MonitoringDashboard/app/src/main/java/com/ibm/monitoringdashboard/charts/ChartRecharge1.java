...
public class ChartRecharge1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_chart_recharge1, container, false);
        barChart=(BarChart) view.findViewById(R.id.chart_rechargetrend);

        data();

        swipeRefreshLayout=view.findViewById(R.id.refresh_chartrech1);
    ...
    public void data(){
        ...
        Call<List<ReportVO>> call=apiInterface.getChartRechargeTrend();
